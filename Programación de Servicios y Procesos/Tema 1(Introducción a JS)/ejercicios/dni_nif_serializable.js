...
return {
  documentoSerializado : fuction (){
    var documento = {};
    documento.formato_corercto = this.comprobarFormato();
    documento.tipoDocumento = this.tipoDocumento();
    documento.letra_dni = this.letraDNI();
    documento.letra_nif_correcta = this.comprobarLetraNIF();
